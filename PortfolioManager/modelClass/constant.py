...
class Constant:
    ...
    CONST_COLUMN_POSITION_PNL = 8
    CONST_COLUMN_POSITION_PNL_PERCENTAGE = 9
    CONST_COLUMN_POSITION_POSITION_PERCENTAGE = 10
    CONST_COLUMN_POSITION_HIDDEN_ID = 11
    #GUI - MOVEMENT VIEW
    ...
    CONST_COLUMN_MOVEMENT_COMMISSION_IVA_AMOUNT = 9
