...
class Constant:
    ...
    CONST_COLUMN_POSITION_GROSS_NET_PERCENTAGE = 11
    CONST_COLUMN_POSITION_REALIZED_PNL = 12
    CONST_COLUMN_POSITION_POSITION_PERCENTAGE = 13
    CONST_COLUMN_POSITION_WEIGHTED_PNL = 14
    CONST_COLUMN_POSITION_HIDDEN_ID = 15
    #GUI - MOVEMENT VIEW
