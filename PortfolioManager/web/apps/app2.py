...
formatColumns = [{"name": 'Custody Name', 'id': 'Custody Name', "deletable": False},
                 {"name": 'Init. Position USD', 'id': 'Initial Position USD', "deletable": False, 'type': 'numeric','format': FormatTemplate.money(2)},
                 {"name": 'Fin. Position USD', 'id': 'Final Position USD', "deletable": False, 'type': 'numeric','format': FormatTemplate.money(2)},
                 {"name": 'PnL USD', 'id': 'PnL USD', "deletable": False, 'type': 'numeric','format': FormatTemplate.money(2)}, 
